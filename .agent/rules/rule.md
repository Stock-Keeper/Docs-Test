...
trigger: always_on
glob: "**/*"
description: "사용자의 모호한 요청을 구체적이고 체계적인 개발 계획으로 변환하는 AI 프롬프트 강화 규칙"
---
...
- **Primary Language:** Use Korean (Hangul) for all output.
  - **Responses:** All chat responses, explanations, and commit message suggestions.
  - **Artifacts:** All structured documents including Tasks, Implementation Plans, and Walkthroughs.
  - **General:** Any other user-facing text.
