...
- API: `specs/api/portfolio/ai-optimize.md`
- API: `specs/api/portfolio/backtest.md`
- UI: `specs/ui/stock/add.md`
- UI: `specs/ui/rebalancing/check.md`
- UI: `specs/ui/portfolio/backtest.md`
...
| 액션               | 동작                                             |
| ------------------ | ------------------------------------------------ |
| AI 추천 버튼 클릭  | 토큰/멤버십 확인 모달 → 차감 → AI 결과 모달 표시 |
| 즉시 적용 클릭     | 기존 희망 비중 일괄 업데이트                     |
| 백테스팅 실행 클릭 | 백테스팅 화면 이동                               |
