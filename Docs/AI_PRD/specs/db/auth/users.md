...
| P2   | name, google_id, is_active, is_profile_complete, profile_character, bio 삭제 |
| P3   | membership_type → membership_tier 변경 (FREE/BASIC/PRO/PREMIUM)              |
| P3   | token_balance, membership_expires_at 추가 (BM 토큰/멤버십 시스템)            |
